...
const Privacy = () => (
  <>
    ...
    <p className="ls2 lh6 bs5 ts4">
      <em className="emphasis">({`'HanseiMelon'`})</em> 은(는) 회사는
      개인정보처리방침을 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여
      공지할 것입니다.
    </p>
    <p className="ls2">
      ○ 본 방침은부터 <em className="emphasis">2019</em>년{' '}
      <em className="emphasis">3</em>월 <em className="emphasis">20</em>
      일부터 시행됩니다.
    </p>
    <p className="lh6 bs4">
      <strong>
    ...
    <p className="ls2">
      회원 가입의사 확인, 회원자격 유지·관리, 서비스 부정이용 방지 등을 목적으로
      개인정보를 처리합니다.
    </p>
    ...
    <p className="ls2">서비스 제공 등을 목적으로 개인정보를 처리합니다.</p>
    <p className="lh6 bs4">
      <strong>2. 개인정보 파일 현황</strong>
    </p>
    <p className="ls2">
      1. 개인정보 파일명 : 개인정보 - 개인정보 항목 : 이메일, 로그인ID, 이름,
      서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보 - 수집방법 : 홈페이지,
      생성정보 수집 툴을 통한 수집 - 보유근거 : 회원님에게 서비스를 제공하기
      위해 수집한 정보를 사용합니다. - 보유기간 : 1년 - 관련법령 : 소비자의 불만
      또는 분쟁처리에 관한 기록 : 3년
    </p>
    ...
    <p>
      ...
      동의일로부터
      {`<1년>`}
      까지 위 이용목적을 위하여 보유.이용됩니다.-보유근거 : 서비스 이용 및 상담
      관리, 중복 확인 체크-관련법령 : 소비자의 불만 또는 분쟁처리에 관한 기록 :
      3년-예외사유 : 2.
      {`<민원사무 처리>`}
      {`<민원사무 처리>`}와 관련한 개인정보는 수집.이용에 관한 동의일로부터
      {`<1년>`}
      까지 위 이용목적을 위하여 보유.이용됩니다.-보유근거 : 상담 관리-관련법령 :
    ...
    <p className="ls2">
      ① 정보주체는 한세멜론에 대해 언제든지 개인정보 열람,정정,삭제,처리정지
      요구 등의 권리를 행사할 수 있습니다.② 제1항에 따른 권리 행사는한세멜론에
      대해 개인정보 보호법 시행령 제41조제1항에 따라 서면, 전자우편,
      모사전송(FAX) 등을 통하여 하실 수 있으며 한세멜론은(는) 이에 대해 지체
      ...
      경우에는 그 삭제를 요구할 수 없습니다.⑥ 한세멜론은(는) 정보주체 권리에
    ...
    <p className="lh6 bs4">
      ...
      <em className="emphasis">
        {`<한세멜론>`}
        {`('https://hansei-melon.com'이하 'HanseiMelon')`}
      </em>
      은(는) 다음의 개인정보 항목을 처리하고 있습니다.
    </p>
    <p className="ls2">
      1{`<홈페이지 회원가입 및 관리>`}- 필수항목 : 이메일, 로그인ID, 이름,
    ...
    <p className="ls2">
      ① 한세멜론 은 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고
      ...
      상단의 {`도구>인터넷 옵션>개인정보 메뉴`}의 옵션 설정을 통해 쿠키 저장을 거부
      할 수 있습니다. 다. 쿠키 저장을 거부할 경우 맞춤형 서비스 이용에 어려움이
      발생할 수 있습니다.
      <p className="lh6 bs4">
        <strong>8. 개인정보 보호책임자 작성 </strong>
      </p>
      {`> ① 한세멜론(‘https://hansei-melon.com’이하 ‘HanseiMelon) 은(는) 개인정보
      처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의
      불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를
      지정하고 있습니다.`}
      <p className="ls2">
        {`>▶ 개인정보 보호책임자>성명 :이동>직책 :관리>직급 :관리>연락처 :
        https://www.facebook.com/Develop.Create>※ 개인정보 보호 담당부서로
        연결됩니다>▶ 개인정보 보호 담당부>부서명 >담당자 >연락처 :
        https://www.facebook.com/Develop.Create/>② 정보주체께서는
        한세멜론(‘https://hansei-melon.com’이하 ‘HanseiMelon) 의 서비스(또는
        사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리,
        피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수
        있습니다. 한세멜론(‘https://hansei-melon.com’이하 ‘HanseiMelon) 은(는)
      ...
      <p className="ls2">
        ...
        정기적(분기 1회)으로 자체 감사를 실시하고 있습니다. 개인정보의
        암호화이용자의 개인정보는 비밀번호는 암호화 되어 저장 및 관리되고 있어,
        본인만이 알 수 있으며 중요한 데이터는 파일 및 전송 데이터를 암호화
        하거나 파일 잠금 기능을 사용하는 등의 별도 보안기능을 사용하고
        있습니다/br3. 접속기록의 보관 및 위변조 방지개인정보처리시스템에 접속한
        기록을 최소 6개월 이상 보관, 관리하고 있으며, 접속 기록이 위변조 및
        도난, 분실되지 않도록 보안기능 사용하고 있습니다/br4. 개인정보에 대한
        접근 제한개인정보를 처리하는 데이터베이스시스템에 대한 접근권한의
