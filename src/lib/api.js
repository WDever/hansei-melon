...
// const top = `https://localhost:8000/api/top-100/`;
// const check = `https://localhost:8000/api/apply-check/`;
// const playlist = `https://localhost:8000/api/music-list/`;
// const apply = `https://localhost:8000/api/apply/`;
// const postToken = `https://localhost:8000/rest-auth/facebook/`;
// const verify = 'https://localhost:8000/api-token-verify/';
...
// export const getALSearch = input => {
//   const search = `https://localhost:8000/api/get_music_album/?q=${input}`;
//   return axios.get(search);
// };

// export const getTSearch = input => {
//   const search = `https://localhost:8000/api/get_music_title/?q=${input}`;
//   return axios.get(search);
// };

// export const getARSearch = input => {
//   const search = `https://localhost:8000/api/get_music_artist/?q=${input}`;
//   return axios.get(search);
// };
